...
#define DMA2D_NO_CSS			((u32)0x00000000U) 	//No chroma sub-sampling 4:4:4
#define DMA2D_CSS_422			((u32)0x00000001U)	//chroma sub-sampling 4:2:2
#define DMA2D_CSS_420			((u32)0x00000002U) 	//chroma sub-sampling 4:2:0  
...
{ 
	...
	vu8 inbuf_read_ptr;								//MDMA IN buf当前读取位置
	vu8 inbuf_write_ptr;							//MDMA IN buf当前写入位置
	vu8 indma_pause;								//输入MDMA暂停状态标识
	vu8 outbuf_read_ptr;							//MDMA OUT buf当前读取位置
	vu8 outbuf_write_ptr;							//MDMA OUT buf当前写入位置
	vu8 outdma_pause;								//输入MDMA暂停状态标识
