...
//JPEG硬件解码输入MDMA配置
//meminaddr:JPEG输入MDMA存储器地址.  
//meminsize:输入MDMA数据长度,0~262143,以字节为单位
...
{ 
	...
	MY_NVIC_Init(2,3,MDMA_IRQn,2);	//抢占2，子优先级3，组2  
}  

//JPEG硬件解码输出MDMA配置 
//memoutaddr:JPEG输出MDMA存储器地址. 
//memoutsize:输出MDMA数据长度,0~262143,以字节为单位 
