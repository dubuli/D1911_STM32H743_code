...
{		 					 
	...
	RCC->APB1LENR|=1<<1;	//TIM3时钟使能    
	RCC->AHB4ENR|=1<<1;   	//使能PORTB时钟	 
	GPIO_Set(GPIOB,PIN5,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_MID,GPIO_PUPD_PU);	//复用功能,上拉输出
...
void TIM7_Int_Init(u16 arr,u16 psc)
{
	...
	TIM7->CR1|=0x01;    //使能定时器7
  	MY_NVIC_Init(1,0,TIM7_IRQn,2);	//抢占0，子优先级1，组2									 
} 
